...
def	check_stats_tables(a, str1):
	...
	if((avg_total_count - 200) < 0):
		RANGE_FROM = 0
	else:
		RANGE_FROM = avg_total_count - 200

	RANGE_TO = avg_total_count + 200
